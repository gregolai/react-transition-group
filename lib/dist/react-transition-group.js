  ...
  */
  ...
  function (_React$Component) {
    ...
    function Transition(props, context) {
      ...
      _this.captureRef = function (ref) {
        _this.node = ref;

        _this.props.captureRef(ref);
      };
    ...
    _proto.performEnter = function performEnter(node, mounting) {
      ...
      var handleNext = function handleNext(maybePromise, callback) {
        if (isPromise(maybePromise)) maybePromise.then(callback);else callback();
      };

      handleNext(this.props.onEnter(node, appearing), function () {
        _this2.safeSetState({
          status: ENTERING
        }, function () {
          handleNext(_this2.props.onEntering(node, appearing), function () {
    ...
    _proto.performExit = function performExit(node) {
      ...
      handleNext(this.props.onExit(node), function () {
        _this3.safeSetState({
          status: EXITING
        }, function () {
          handleNext(_this3.props.onExiting(node), function () {
    ...
    _proto.render = function render() {
      ...
      return React__default.cloneElement(child, _extends({}, childProps, {
        ref: this.captureRef
      }));
    };
